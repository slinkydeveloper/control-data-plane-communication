...
import (
	...
	internalinterfaces "knative.dev/control-data-plane-communication/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "knative.dev/control-data-plane-communication/pkg/client/listers/samples/v1alpha1"
)
...
type SampleSourceInformer interface {
	...
	Lister() v1alpha1.SampleSourceLister
}
...
func (f *sampleSourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplesv1alpha1.SampleSource{}, f.defaultInformer)
}

func (f *sampleSourceInformer) Lister() v1alpha1.SampleSourceLister {
	return v1alpha1.NewSampleSourceLister(f.Informer().GetIndexer())
}
